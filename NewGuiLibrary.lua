local VERSION = "v4.06 ENGO-PRIVATE"
...
api["SaveSettings"] = function()
	if loadedsuccessfully then
		writefile("engovape/Profiles/"..game.PlaceId..".vapeprofiles", game:GetService("HttpService"):JSONEncode(api["Profiles"]))
		local WindowTable = {}
		...
		writefile("engovape/Profiles/"..(api["CurrentProfile"] == "default" and "" or api["CurrentProfile"])..game.PlaceId..".vapeprofile", game:GetService("HttpService"):JSONEncode(api["Settings"]))
		writefile("engovape/Profiles/GUIPositions.vapeprofile", game:GetService("HttpService"):JSONEncode(WindowTable))
	end
end

api["LoadSettings"] = function()
	local success2, result2 = pcall(function()
		return game:GetService("HttpService"):JSONDecode(readfile("engovape/Profiles/"..game.PlaceId..".vapeprofiles"))
	end)
	...
	local success3, result3 = pcall(function()
		return game:GetService("HttpService"):JSONDecode(readfile("engovape/Profiles/GUIPositions.vapeprofile"))
	end)
	...
	local success, result = pcall(function()
		return game:GetService("HttpService"):JSONDecode(readfile("engovape/Profiles/"..(api["CurrentProfile"] == "default" and "" or api["CurrentProfile"])..game.PlaceId..".vapeprofile"))
	end)
...
api["SwitchProfile"] = function(profilename)
	...
	if (not isfile("engovape/Profiles/"..(profilename == "default" and "" or profilename)..game.PlaceId..".vapeprofile")) then
...
api["CreateMainWindow"] = function()
	...
	windowshadow.Image = getcustomassetfunc("engovape/assets/WindowBlur.png")
	...
	windowlogo1.Image = getcustomassetfunc("engovape/assets/VapeLogo1.png")
	...
	windowlogo2.Image = getcustomassetfunc("engovape/assets/VapeLogo2.png")
	...
	settingsicon.Image = getcustomassetfunc("engovape/assets/SettingsWheel2.png")
	...
	settingswheel.Image = getcustomassetfunc("engovape/assets/SettingsWheel1.png")
	...
	discordbutton.Image = getcustomassetfunc("engovape/assets/DiscordIcon.png")
	...
	settingsexit.Image = getcustomassetfunc("engovape/assets/ExitIcon1.png")
	...
	overlaysicon.Image = getcustomassetfunc("engovape/assets/TextGUIIcon4.png")
	...
	overlaysexit.Image = getcustomassetfunc("engovape/assets/ExitIcon1.png")
	...
	overlaysbutton.Image = getcustomassetfunc("engovape/assets/TextGUIIcon2.png")
	...
	windowapi["CreateColorSlider"] = function(name, temporaryfunction)
		...
		slider3.Image = getcustomassetfunc("engovape/assets/SliderButton1.png")
	...
	windowapi["CreateToggle"] = function(argstable)
		...
		buttonarrow.Image = getcustomassetfunc("engovape/assets/ToggleArrow.png")
	...
	windowapi["CreateButton"] = function(argstable)
		...
		arrow.Image = getcustomassetfunc("engovape/assets/RightArrow.png")
		arrow.Active = false
		arrow.Parent = button
		local buttonicon
...
api["CreateCustomWindow"] = function(argstablemain)
	...
	expandbutton.Image = getcustomassetfunc("engovape/assets/PinButton.png")
	...
	optionsbutton.Image = getcustomassetfunc("engovape/assets/MoreButton3.png")
...
api["CreateWindow"] = function(argstablemain2)
	...
	windowbackbutton.Image = getcustomassetfunc("engovape/assets/BackIcon.png")
	...
	expandbutton2.Image = getcustomassetfunc("engovape/assets/UpArrow.png")
	...
	windowapi["ExpandToggle"] = function()
		if noexpand == false then
			...
			if children.Visible then
				expandbutton2.Image = getcustomassetfunc("engovape/assets/DownArrow.png")
				windowtitle.Size = UDim2.new(0, 220, 0, 45 + uilistlayout.AbsoluteContentSize.Y)
			else
				expandbutton2.Image = getcustomassetfunc("engovape/assets/UpArrow.png")
				windowtitle.Size = UDim2.new(0, 220, 0, 41)
	...
	windowapi["CreateOptionsButton"] = function(argstablemain)
		...
		button2.Image = getcustomassetfunc("engovape/assets/MoreButton1.png")
		...
		buttonapi["ToggleButton"] = function(clicked, toggle)
			...
			if buttonapi["Enabled"] then
				...
				button2.Image = getcustomassetfunc("engovape/assets/MoreButton2.png")
		...
		buttonapi["CreateTextList"] = function(argstable)
			...
			textboxbkg.Image = getcustomassetfunc("engovape/assets/TextBoxBKG.png")
			...
			addbutton.Image = getcustomassetfunc("engovape/assets/AddItem.png")
			...
			textapi["RefreshValues"] = function(tab)
				...
				for i,v in pairs(textapi["ObjectList"]) do
					...
					deletebutton.Image = getcustomassetfunc("engovape/assets/AddRemoveIcon1.png")
		...
		buttonapi["CreateTargetWindow"] = function(argstablemain3)
			...
			windowicon.Image = getcustomassetfunc("engovape/assets/TargetIcon.png")
			windowicon.ImageColor3 = Color3.fromRGB(200, 200, 200)
			windowicon.ZIndex = 3
			windowicon.Name = "WindowIcon"
			windowicon.BackgroundTransparency = 1
			...
			buttonreturned["Players"] = windowapi["CreateButton"]({
				...
				["Icon"] = "engovape/assets/TargetIcon1.png",
				["IconSize"] = 15,
			...
			buttonreturned["NPCs"] = windowapi["CreateButton"]({
				...
				["Icon"] = "engovape/assets/TargetIcon2.png",
				["IconSize"] = 12,
				["Function"] = function() end,
				["Default"] = false
			})
			buttonreturned["Peaceful"] = windowapi["CreateButton"]({
				...
				["Icon"] = "engovape/assets/TargetIcon3.png",
				["IconSize"] = 16,
				["Function"] = function() end,
				["Default"] = false
			})
			buttonreturned["Neutral"] = windowapi["CreateButton"]({
				...
				["Icon"] = "engovape/assets/TargetIcon4.png",
				["IconSize"] = 19,
				["Function"] = function() end,
				["Default"] = false
			})
		...
		buttonapi["CreateTwoSlider"] = function(argstable)
			...
			text4.Image = getcustomassetfunc("engovape/assets/SliderArrowSeperator.png")
			...
			slider3.BackgroundColor3 = Color3.fromRGB(26, 25, 26)
			slider3.BorderSizePixel = 0
			slider3.Image = getcustomassetfunc("engovape/assets/SliderArrow1.png")
...
api["CreateWindow2"] = function(argstablemain)
	...
	settingsbutton.Image = getcustomassetfunc("engovape/assets/SettingsWheel2.png")
...
api["CreateNotification"] = function(top, bottom, duration, customicon)
		...
		icon.Name = "IconLabel"
		icon.Image = getcustomassetfunc(customicon or "engovape/assets/InfoNotification.png")
